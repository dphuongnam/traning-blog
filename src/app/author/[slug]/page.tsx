...
const ListCategoryPosts = ({ params }: { params: { slug: string } }, props: IProps) => {
    const { blogs } = props;
    ...
    const filteredPosts = blogPosts.filter((blogPost) => (
        blogPost.author === decodeURIComponent(params.slug)
    ));
    ...
    return (
        <>
            ...
            <div className="container">
                <div className="mt-5 mb-5"><h3>List Post Of Category : {decodeURIComponent(params.slug)}</h3></div>
